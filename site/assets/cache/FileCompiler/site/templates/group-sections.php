 ...
 <div class="container page-section  mg-t-lg <?php echo $bodySpacing;?>">
    <div class="row ">
       ...
       <?php if( count($page->tabbed_content) > 0 ){
                        ...
                        $t = new \ProcessWire\TemplateFile(\ProcessWire\wire('files')->compile(\ProcessWire\wire('config')->paths->templates .'markup/groups/tabbed_content.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
