# --- WireDatabaseBackup {"time":"2016-09-03 14:23:50","user":"admin","dbName":"cms","description":"Automatic backup made by ProcessWireUpgrade before upgrading from 2.7.2 to 3.0.33.","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
