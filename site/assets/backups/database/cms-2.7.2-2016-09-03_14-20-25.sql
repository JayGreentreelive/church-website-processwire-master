# --- WireDatabaseBackup {"time":"2016-09-03 14:20:25","user":"admin","dbName":"cms","description":"Automatic backup made by ProcessWireUpgrade before upgrading from 2.7.2 to 3.0.33.","tables":[],"excludeTables":[],"excludeCreateTables":[],"excludeExportTables":[]}
...
# --- /WireDatabaseBackup {"numTables":98,"numCreateTables":98,"numInserts":1952,"numSeconds":13}